...
contract DividendDistributor is IDividendDistributor, SafeToken {
    ...
    uint256 public minimumTokenBalanceForDividends = 6800000000 * (10**9); // user must hold 20,000,000 token
...
contract FUNK is
    BASEToken("FU North KoreaToken", "FUNK", 68000000000000 * 10**9, 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
